...
class ConanRecipe(DenverConanFile):
    ...
    exports_sources = (
        ...
        "toolchain_gnu_linux-x86_64_x86_64-zephyr-elf.tar.xz",
        "toolchain_gnu_linux-x86_64_riscv64-zephyr-elf.tar.xz",
    )
    ...
    def package_info(self):
        ...
        self.cpp_info.bindirs = [
            str(sdk_dir / "gnu" / "arm-zephyr-eabi" / "bin"),
            str(sdk_dir / "gnu" / "riscv64-zephyr-elf" / "bin"),
            str(sdk_dir / "gnu" / "x86_64-unknown-linux-gnu" / "bin"),
        ]
